...
void setup()
{
  ...
  Fan.On1Hr     = EEPROM.read(42);
  Fan.On1Min    = EEPROM.read(43);
  Fan.Dur1Min   = EEPROM.read(44);
  Fan.Dur1Sec   = EEPROM.read(45);
  Fan.On2Hr     = EEPROM.read(46);
  Fan.On2Min    = EEPROM.read(47);
  Fan.Dur2Min   = EEPROM.read(48);
  Fan.Dur2Sec   = EEPROM.read(49);
...
void loop()
{
  ...
  Serial.print(F("updateTimeDate delay: "));
  ...
  unsigned long rightNow = (millis() / 1000);
