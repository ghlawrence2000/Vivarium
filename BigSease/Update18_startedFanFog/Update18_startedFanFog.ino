...
{ //                                                                                                //
  ...
  myFiles.loadcpld(0, 0, 800, 480, "46SchedG.raw", 4, 3); //Fan/Fog to save video pages...          //
...
void processMyTouch() // this is a huge block dedicated to processing all touch screen events
{
  ...
  switch (dispScreen)
  {
    ...
    case 6:    // Fan screen
      ...
      if ((tempFan1.Enable & 0xF0)) // If Enable Fog 1
      {
        if ((y >= 174) && (y < 218))
        {
          fanScreen = 1;
...
void ffTimePrint(SCHEDULE mist, byte mscreen)
{
  ...
  Serial.println(mist.OnDay, HEX);
  Serial.print(F("OnDay2 : "));
  Serial.println(mist.OnDay2, HEX);
#endif
