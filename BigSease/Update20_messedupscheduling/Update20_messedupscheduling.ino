...
{ //                                                                                                //
  ...
  if (Light.On1Hr < 10)
    Serial.print('0');
  Serial.print(Light.On1Hr);
  if (Light.On1Min < 10)
    Serial.print('0');
  Serial.print(Light.On1Min);
  Serial.print(' ');
  if (Light.Dur1Min < 10)
    Serial.print('0');
  Serial.print(Light.Dur1Min);
  if (Light.Dur1Sec < 10)
    Serial.print('0');
  Serial.print(Light.Dur1Sec);
  Serial.println();
  if (Light.On2Hr < 10)
    Serial.print('0');
  Serial.print(Light.On2Hr);
  if (Light.On2Min < 10)
    Serial.print('0');
  Serial.print(Light.On2Min);
  Serial.print(' ');
  if (Light.Dur2Min < 10)
    Serial.print('0');
  Serial.print(Light.Dur2Min);
  if (Light.Dur2Sec < 10)
    Serial.print('0');
  Serial.print(Light.Dur2Sec);
  Serial.println();
  //setAlarms();
} //                                                                                                //
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
void setAlarms()
{
  if (alarmset == 225)
  {
    ...
    alarms[4] = Alarm.timerRepeat(15, Repeats);          // timer for every 15 seconds
    for (byte q = 0; q < 5; q++)
    {
  ...
  {
    Serial.println("reset alarms here/disable 15s repeat");
    for ( byte q = 0; q < 5; q++)
    {
      Alarm.free(alarms[q]);
